export const landingPageStyles = {
  ...
  // Auth buttons
  desktopAuthButton: "relative group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl  transition-all hover:scale-105 hover:shadow-xl hover:shadow-violet-200",
desktopAuthButtonOverlay: "absolute inset-0 bg-gradient-to-r from-fuchsia-600 to-violet-600 opacity-100 group-hover:opacity-100 transition-opacity z-0", // add z-0
desktopAuthButtonText: "relative z-10", // add z-10
...
heroLeft: "flex-1 space-y-8 text-center md:text-left",
  ...
  primaryButtonOverlay: "absolute inset-0 bg-gradient-to-r from-fuchsia-600 to-orange-500 opacity-1 group-hover:opacity-100 transition-opacity",
...
// Hero illustration
heroIllustration: "flex-1 relative w-full max-w-sm sm:max-w-md lg:max-w-lg mx-auto flex items-center justify-center",
...
svgAnimatedPolygon: "fill-[#ef4444] opacity-80",
  ...
  ctaButtonOverlay: "absolute inset-0 bg-gradient-to-r from-fuchsia-600 to-orange-500 opacity-1 group-hover:opacity-100 transition-opacity",
...
createButtonOverlay: "absolute inset-0 bg-gradient-to-r from-fuchsia-600 to-orange-500 opacity-100 group-hover:opacity-100 transition-opacity z-0",  // Add z-0 and opacity-100
createButtonContent: "relative flex items-center gap-3 z-10", // Add z-10
 ...
 // Delete Confirmation
deleteIconWrapper: "bg-red-100 p-3 rounded-full mb-4 flex items-center justify-center mx-auto",
deleteTitle: "text-lg font-bold text-gray-900 mb-2 text-center",
deleteText: "text-gray-600 mb-4 text-center",
...
export const cardStyles = {
  ...
  profileCard:
    "absolute top-4 right-6 flex items-center gap-3 px-4 py-2 bg-white backdrop-blur-xl border border-gray-200 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02] z-50",

  profileInitialsContainer:
    "w-10 h-10 sm:w-11 sm:h-11 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-full flex items-center justify-center shadow-md",

  profileInitialsText: "text-base sm:text-lg font-black text-white",

  profileName: "text-sm sm:text-base font-semibold text-gray-800",

  logoutButton:
    "ml-2 text-violet-600 text-xs sm:text-sm font-bold cursor-pointer hover:text-fuchsia-600 transition-colors",
